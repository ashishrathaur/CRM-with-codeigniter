         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  ...
                  <small>Running Services details</small>
               </div>
            </section>
            <!-- Main content -->
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td><?php echo ucwords(strtolower($runningDetail->subscriberName)); ?></td>
                                       <td><?php echo $runningDetail->productName; ?></td>
                                       <?php
                                       $subdate=date("d M Y", $runningDetail->subscriptionDate);
                                       // $pay_date = date_format($date,"d M Y"); 
                                       ?>
                                       <td><?php echo $subdate; ?></td>
                                       <?php
                                       // $due = date("Y-m-d H:i:s", strtotime("+1 years", strtotime($runningDetail->pay_date)));
                                       ...
                                       <td>
                                          ...
                                          ?>
                                          <span class="label-<?php echo $color; ?> label label-default"><?php echo $runningDetail->pay_status; ?></span>
                                       </td>
                                       <td>
                                          <button type="button" class="btn btn-add btn-xs" data-toggle="modal" data-target="#update-<?php echo $runningDetail->id; ?>"><i class="fa fa-pencil"></i></button>

                                           <!-- <?php //echo $runningDetail->id; ?> -->

                                          <button type="button" value="<?php echo $runningDetail->id; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delt-<?php echo $runningDetail->id; ?>"><i class="fa fa-trash-o"></i> </button>
                                       </td>
                                    </tr>
                                     <!-- delete user Modal2 -->
                                    <div class="modal fade" id="delt-<?php echo $runningDetail->id; ?>" tabindex="-1" role="dialog">
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <form method="post" action="<?= base_url('admin/customer/delete_task'); ?>" class="form-horizontal">
                                                         <input type="hidden" name="id" value="<?php echo $runningDetail->id; ?>">
                                                         <fieldset>
                                                            <div class="col-md-12 form-group user-form-group">
                                                               <label class="control-label">Confirm Deletion<!-- Are you sure delete task of <?php echo ucwords(strtolower($runningDetail->subscriberName)); ?> ? --></label>
                                    ...
                                    <!-- Modal1 -->
                                    <div class="modal fade" id="update-<?php echo $runningDetail->id; ?>" tabindex="-1" role="dialog">
                                       <div class="modal-dialog">
                                          <div class="modal-content">
                                             <div class="modal-header modal-header-primary">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <form class="form-horizontal" method="post" action="<?= base_url('admin/customer/edit_task'); ?>">
                                                         <input type="hidden" name="id" value="<?php echo $runningDetail->id; ?>">
                                                         <?php
                                                         // $date=date_create($runningDetail->Due_date);
                                                         // $due_date1 = date_format($date,"m/d/Y"); ?>
                                                         <fieldset>
                                                            <!-- Text input-->
                                                            <!-- <div class="col-md-6 form-group">
                                                               <label class="control-label">Subscriber Name</label>
                                                               <input type="text" name="subscriberName" id="subscriberName" placeholder="Client Name" value="<?php echo ucwords(strtolower($runningDetail->subscriberName)); ?>" class="form-control">
                                                            </div> -->
                                                            <div class="col-md-6 form-group">
                                                               <label class="control-label">Service Name</label>
                                                               <input type="text" name="productName" id="productName" placeholder="Task Name" value="<?php echo $runningDetail->productName; ?>" class="form-control">
                                                            </div>
                                                           <!--  <div class="col-md-6 form-group">
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                               ...
                                                               <input type="number" name="productAmount" id="productAmount" placeholder="Amount" value="<?php echo $runningDetail->productAmount; ?>" class="form-control">
                                                            </div>
                                                            <div class="col-md-6 form-group">
                                                               <label class="control-label">product validity</label>
                                                               <input type="text" name="productValidity" id="productValidity" placeholder="productValidity" value="<?php echo $runningDetail->productValidity; ?>" class="form-control">
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                               ...
                                                               <input type="text" name="status" id="cstatus" placeholder="status" value="<?php echo $runningDetail->status; ?>" class="form-control"> -->
                                                            </div>
                                                            <div class="col-md-6 form-group">
