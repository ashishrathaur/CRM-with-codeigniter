   ...
   <body class="hold-transition sidebar-mini">
      ...
      <div class="wrapper">
         <header class="main-header">
            <a href="<?= base_url('admin/Welcome'); ?>" class="logo">
               <!-- Logo -->
               <span class="logo-mini">
               <img src="https://www.zopsoft.com/themes/zopsoft/images/logo.png" alt="" width="50" height="36">
               </span>
               <span class="logo-lg">
               <img src="https://www.zopsoft.com/themes/zopsoft/images/logo.png" alt="">
               </span>
            </a>
            <!-- Header Navbar -->
