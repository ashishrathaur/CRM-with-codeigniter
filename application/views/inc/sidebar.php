         ...
         <aside class="main-sidebar">
            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                  <li class="active">
                     <a href="<?= base_url('Welcome'); ?>"><i class="fa fa-tachometer"></i><span>Dashboard</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
                  <li class="treeview">
                     <a href="<?= base_url('customer/running_task'); ?>">
                     <i class="fa fa-opencart"></i><span>Active Services</span>
                    <!--  <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span> -->
                     </a>
                     <!-- <ul class="treeview-menu"> -->
                        <!-- <li><a href="<?= base_url('customer/add_customer');?>">Add Customer</a></li> -->
                        <!-- <li><a href="<?= base_url('customer');?>">Customer List</a></li> -->
                 ...
                 <!--  <li class="treeview">
                  ...
                  <li class="treeview">
                     ...
                     <i class="fa fa-book"></i><span>Due Payment</span>
                  <!--    <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span> -->
                     </a>
                    <!--  <ul class="treeview-menu">
                        <li><a href="<?= base_url('customer/running_task'); ?>">Running Services</a></li>
                        <li><a href="<?= base_url('customer/unpaid_service'); ?>">Unpaid Services</a></li>
                     </ul> -->
                  </li>
                  <!-- <li class="treeview">
                     <a href="#">
