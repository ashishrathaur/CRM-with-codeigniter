                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <?php if(count($unpaid_task)):
                                     ...
                                     ?>
                                    <tr>
                                       <td><?php echo ucwords(strtolower($unpaidDetail->subscriberName)); ?></td>
                                       <td><?php echo $unpaidDetail->productName; ?></td>
                                       <?php
                                       $subdate=date("d M Y", $unpaidDetail->subscriptionDate);
                                       ...
                                       <td>
                                          <span class="label-danger label label-default"><?php echo $unpaidDetail->pay_status; ?></span>
                                       </td>
                                       <td>
                                          <button type="button" class="btn btn-add btn-xs" data-toggle="modal" data-target="#update-<?php echo $unpaidDetail->id; ?>"><i class="fa fa-pencil"></i></button>

                                           <!-- <?php //echo $unpaidDetail->id; ?> -->

                                          <button type="button" value="<?php echo $unpaidDetail->id; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delt-<?php echo $unpaidDetail->id; ?>"><i class="fa fa-trash-o"></i> </button>
                                       </td>
                                    </tr>
                                     <!-- delete user Modal2 -->
                                    <div class="modal fade" id="delt-<?php echo $unpaidDetail->id; ?>" tabindex="-1" role="dialog">
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <form method="post" action="<?= base_url('admin/customer/delete_task'); ?>" class="form-horizontal">
                                                         <input type="hidden" name="id" value="<?php echo $unpaidDetail->id; ?>">
                                                         <fieldset>
                                                            <div class="col-md-12 form-group user-form-group">
                                                               <label class="control-label">Confirm Deletion<!-- Are you sure delete task of <?php echo ucwords(strtolower($unpaidDetail->subscriberName)); ?> ? --></label>
                                    ...
                                    <!-- Modal1 -->
                                    <div class="modal fade" id="update-<?php echo $unpaidDetail->id; ?>" tabindex="-1" role="dialog">
                                       <div class="modal-dialog">
                                          <div class="modal-content">
                                             <div class="modal-header modal-header-primary">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <form class="form-horizontal" method="post" action="<?= base_url('admin/customer/edit_task'); ?>">
                                                         <input type="hidden" name="id" value="<?php echo $unpaidDetail->id; ?>">
                                                         <?php
                                                         // $date=date_create($unpaidDetail->Due_date);
                                                         // $due_date1 = date_format($date,"m/d/Y"); ?>
                                                         <fieldset>
                                                            <!-- Text input-->
                                                            <!-- <div class="col-md-6 form-group">
                                                               <label class="control-label">Suscriber Name</label>
                                                               <input type="text" name="subscriberName" id="subscriberName" placeholder="Client Name" value="<?php echo ucwords(strtolower($unpaidDetail->subscriberName)); ?>" class="form-control">
                                                            </div> -->
                                                            <div class="col-md-6 form-group">
                                                               <label class="control-label">Service Name</label>
                                                               <input type="text" name="productName" id="productName" placeholder="Task Name" value="<?php echo $unpaidDetail->productName; ?>" class="form-control">
                                                            </div>
                                                            <!-- <div class="col-md-6 form-group">
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                               ...
                                                               <input type="number" name="productAmount" id="productAmount" placeholder="Amount" value="<?php echo $unpaidDetail->productAmount; ?>" class="form-control">
                                                            </div>
                                                            <div class="col-md-6 form-group">
                                                               <label class="control-label">product validity</label>
                                                               <input type="text" name="productValidity" id="productValidity" placeholder="productValidity" value="<?php echo $unpaidDetail->productValidity; ?>" class="form-control">
                                                            </div>
