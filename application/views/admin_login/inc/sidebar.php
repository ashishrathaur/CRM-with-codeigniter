         ...
         <aside class="main-sidebar">
            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                  <li class="active">
                     <a href="<?= base_url('admin/Welcome'); ?>"><i class="fa fa-tachometer"></i><span>Dashboard</span>
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        ...
                        <li><a href="<?= base_url('admin/customer');?>">Customer List</a></li>
                         <li><a href="<?= base_url('admin/customer/addNewCustomer'); ?>">Add Customer</a></li>
                        <li><a href="<?= base_url('admin/customer/add_customer_services');?>">Add Customer Services</a></li>
                 ...
                 <!--  <li class="treeview">
                  ...
                  <li class="treeview">
                     <a href="#">
                     <i class="fa fa-book"></i><span>Renewals</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>
                     <ul class="treeview-menu">
                        <li><a href="<?= base_url('admin/customer/running_task'); ?>">All</a></li>
                        <li><a href="<?= base_url('admin/customer/unpaid_service'); ?>">Unpaid</a></li>
                         <li><a href="<?= base_url('admin/customer/archive_services'); ?>">Archive</a></li>
                     </ul>
                  </li>
                   <li class="treeview">
                     <a href="<?= base_url('admin/Services'); ?>">
                     <i class="fa fa-bitbucket-square"></i><span>Services</span>
                   <!--   <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span> -->
                     </a>
